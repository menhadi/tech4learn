...
python3 -B "$source/test-pdf-worker-install.py" /home/examelite/public_html/app/Jobs/GenerateExamPdfJob.php
...
php "$source/test-answer-extraction.php" /home/examelite/public_html/vendor/autoload.php /home/examelite/public_html/public/extract_file.php
...
php "$source/test-passage-image-upload.php" /home/examelite/public_html/vendor/autoload.php
