...
Route::prefix('tech4learn/v1')->withoutMiddleware('throttle:api')->middleware('throttle:120,1,t4l-answer-attachments:')->group(function () {
    Route::post('/attachments/{org}/{action}', [Tech4LearnAttachmentController::class, 'attachment'])->where('action','upload|read|review|extract|languages');
});
...
Route::prefix('tech4learn/v1')->withoutMiddleware('throttle:api')->middleware('throttle:1800,1,t4l-authoring-media:')->group(function () {
    ...
    Route::post('/authoring/{org}/passages/{id}/image', [Tech4LearnAuthoringController::class, 'passageImageWrite']);
});
Route::prefix('tech4learn/v1')->middleware('throttle:30,1')->group(function () {
    ...
    Route::post('/central/passages/{id}/image', [Tech4LearnContentController::class, 'centralPassageImageWrite']);
