...
if(!method_exists(\App\Http\Controllers\ExamDocumentController::class,'approve'))throw new RuntimeException('Native translation approval controller is missing.');
if(!method_exists(\App\Services\ExamDocumentBulkActionService::class,'process'))throw new RuntimeException('Native translation queue service is missing.');
foreach([\App\Services\Tech4LearnTranslationEdits::class,\App\Http\Controllers\QuestionLangController::class] as $service)if(!class_exists($service))throw new RuntimeException('Native question translation editing is missing.');
...
foreach([
 ['GET','api/tech4learn/v1/central/exams/1/translations/1/media/0/'.str_repeat('a',64),'Tech4LearnTranslationController@centralMedia'],
 ...
 ['POST','api/tech4learn/v1/attachments/11111111-1111-1111-1111-111111111111/languages','Tech4LearnAttachmentController@attachment'],
 ...
 ['GET','api/tech4learn/v1/central/passages/1/languages/1/media/'.str_repeat('a',64),'Tech4LearnAuthoringController@centralPassageMedia'],
 ['POST','api/tech4learn/v1/central/passages/1/image','Tech4LearnContentController@centralPassageImageWrite'],
 ['POST','api/tech4learn/v1/central/packages/1/image','Tech4LearnContentController@centralPackageImageWrite'],
 ['POST','api/tech4learn/v1/central/exams/1/actions/add-questions','Tech4LearnContentController@centralExamAction'],
 ['GET','api/tech4learn/v1/central/exams/1/questions','Tech4LearnAuthoringController@centralExamQuestions'],
 ...
 ['POST','api/tech4learn/v1/central/taxonomy/languages/1/delete','Tech4LearnContentController@centralLanguageDelete'],
 ...
 ['GET','api/tech4learn/v1/authoring/11111111-1111-1111-1111-111111111111/passages/1/languages/1/media/'.str_repeat('a',64),'Tech4LearnAuthoringController@passageMedia'],
 ['POST','api/tech4learn/v1/authoring/11111111-1111-1111-1111-111111111111/passages/1/image','Tech4LearnAuthoringController@passageImageWrite'],
