...
backup="/root/tech4learn-backups/before-attendance-$(date -u +%Y%m%dT%H%M%S).dump"
cd /tmp
...
printf '\nAttendance deployed. Superadmin: enable Attendance in Setup, then configure staff roles and approved centre coordinates.\n'
