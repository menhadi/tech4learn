...
backup="/root/tech4learn-backups/before-configuration-$(date -u +%Y%m%dT%H%M%S).dump"
cd /tmp
...
printf '\nOrganisation configuration deployed. Sign in and check Setup and Custom fields.\n'
