...
backup="/root/tech4learn-backups/before-workspace-ai-$(date -u +%Y%m%dT%H%M%S).dump"
cd /tmp
...
printf '\nWorkspace and vision pilot deployed. Check Daily overview, Roles, AI connections and Learners.\n'
