...
backup="/root/tech4learn-backups/before-academic-$(date -u +%Y%m%dT%H%M%S).dump"
cd /tmp
...
printf '\nAcademic structure deployed. Check Centres and Classes & sections. Existing groups remain unassigned until linked.\n'
