...
Images embedded in student answers or stored reference answers, unsupported media types and broader exam workflow verification remain unfinished. The adapter does not fetch arbitrary student-supplied image references.
